...
$(function() {
	...
	$("#bt2").click(function(){ /* 장바구니 테이블로 상품명,사이즈,수량,가격,총가격 넘겨주기 */
		name = "<%=dto2.getName() %>"; 
		size = $("#size").val();
		count = $("#amount").val();
		price = "<%=dto2.getPrice() %>";
	...
	<div id="total">
		...
		<div id="center" style="height: auto;">
			...
			<div id="uniform_img"><br>
				<li><a><img src="../img/product/1번_팀.jpg"></a></li>
			</div>
					...
					<div>
						<form name="form" method="get">
							<br><div class="d">금액</div>
								<input type=hidden name="sell_price" value="89000">
								<input id="allprice" type="text" name="sum" readonly>원
			...
			<div id="uniform1_info_img">
				...
				<li><img src="../img/product/1번_팀1.JPG"></li><br><br><br><br><br>
				<li><img src="../img/product/1번_팀2.JPG"></li><br><br><br><br><br>
				<li><img src="../img/product/1번_팀3.JPG"></li><br><br><br><br><br>
