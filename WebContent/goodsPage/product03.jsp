...
<script type="text/javascript">
$(function() { /* 장바구니 테이블로 상품명,사이즈,수량,가격,총가격 넘겨주기 */
	$("#bt2").click(function(){
		$.ajax({
			url: "basket.jsp",
			data:{
	...
	<div id="total">
		...
		<div id="center" style="height: auto;">
			...
			<div id="uniform_img"><br>
				<li><a><img src="../img/product/3번_팀.jpg"></a></li>
			</div>
					...
					<div>
						<form name="form" method="get">
							<br><div class="d">금액</div>
								<input id="allprice" type=hidden name="sell_price" value="128000">
			...
			<div id="uniform1_info_img">
				...
				<li><img src="../img/product/3번_팀1.jpg"></li><br><br><br><br><br>
				<li><img src="../img/product/3번_팀2.jpg"></li><br><br><br><br><br>
				<li><img src="../img/product/3번_팀3.jpg"></li><br><br><br><br><br>
